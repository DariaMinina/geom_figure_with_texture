...
GLvoid LoadGLTextures()
{
	...
	texture1 = auxDIBImageLoad("Data/CUBE.bmp");
	// Создание текстуры
...
GLvoid DrawGLScene(GLvoid)
{
	...
	// Передняя грань
	glTexCoord2f(0.5f, 1.5f); glVertex3f(0.0f, 1.0f, 0.71f); // верх 
	glTexCoord2f(-0.5f, 0.5f); glVertex3f(-1.0f, 0.0f, 0.71f); //лево
	glTexCoord2f(0.5f, -0.5f); glVertex3f(0.0f, -1.0f, 0.71f); // низ 
	glTexCoord2f(1.5f, 0.5f); glVertex3f(1.0f, 0.0f, 0.71f); // право
	
	
	// Задняя грань
	glTexCoord2f(0.5f, 1.5f); glVertex3f(0.0f, 1.0f, -0.71f);
	glTexCoord2f(-0.5f, 0.5f); glVertex3f(-1.0f, 0.0f, -0.71f);
	glTexCoord2f(0.5f, -0.5f); glVertex3f(0.0f, -1.0f, -0.71f);
	glTexCoord2f(1.5f, 0.5f); glVertex3f(1.0f, 0.0f, -0.71f);
	

	// Верхняя левая грань
	glTexCoord2f(0.5f, 1.5f); glVertex3f(0.0f, 1.0f, -0.71f);	// верх право
	glTexCoord2f(-0.5f, 0.5f); glVertex3f(-1.0f, 0.0f, -0.71f);	// верх лево
	glTexCoord2f(0.5f, -0.5f); glVertex3f(-1.0f, 0.0f, 0.71f);	// низ лево
	glTexCoord2f(1.5f, 0.5f); glVertex3f(0.0f, 1.0f, 0.71f);	// низ право
	
	
	// Верхняя правая грань
	glTexCoord2f(0.5f, 1.5f); glVertex3f(1.0f, 0.0f, -0.71f);	// верх лево
	glTexCoord2f(-0.5f, 0.5f); glVertex3f(0.0f, 1.0f, -0.71f);	// верх право
	glTexCoord2f(0.5f, -0.5f); glVertex3f(0.0f, 1.0f, 0.71f);	// низ право
	glTexCoord2f(1.5f, 0.5f); glVertex3f(1.0f, 0.0f, 0.71f);	// низ лево
	

	// Нижняя левая грань
	glTexCoord2f(0.5f, 1.5f); glVertex3f(-1.0f, 0.0f, 0.71f);	// низ лево
	glTexCoord2f(-0.5f, 0.5f); glVertex3f(-1.0f, 0.0f, -0.71f); // верх лево
	glTexCoord2f(0.5f, -0.5f); glVertex3f(0.0f, -1.0f, -0.71f);	// верх право
	glTexCoord2f(1.5f, 0.5f); glVertex3f(0.0f, -1.0f, 0.71f);	// низ право
	...
	glTexCoord2f(-0.5f, 0.5f); glVertex3f(0.0f, -1.0f, 0.71f);	// низ право
	glTexCoord2f(0.5f, -0.5f); glVertex3f(0.0f, -1.0f, -0.71f);	// верх право
	glTexCoord2f(1.5f, 0.5f); glVertex3f(1.0f, 0.0f, -0.71f);	// верх лево
	...
	xrot+=5.0f;			// Ось вращения X
	yrot+=-5.0f;				// Ось вращения Y
	zrot+=4.0f;				// Ось вращения Z
	Sleep(16);
